...
team_rows = [
    (6, 'ASHİNA', 'insansiz-hava-araclari', 'Havacılıkta tasarımdan uçuşa',
    ...
    (7, 'MATROVER & LUNA', 'insansiz-kara-araci', 'Arazide çalışan robotlar',
    ...
    (9, 'İSS / PRUSA', 'insansiz-su-alti-sistemleri', 'Suyun altında mühendislik',
    ...
    (10, 'ZEMHERİ / SARA', 'su-alti-roket-sistemleri', 'Yeni bir çalışma alanı',
    ...
    (11, 'MATRİS', 'suru-insansiz-hava-araci', 'Birlikte hareket eden hava araçları',
    ...
    (12, 'PUSULA / ANDROMEDA', 'sanayide-robotik-ve-dijital', 'Üretim süreçleri için akıllı sistemler',
    ...
    (13, 'GÖKSAV / ASHİNA-H', 'hava-savunma-sistemleri', 'Takip ve kontrol sistemleri',
    ...
    (14, 'BÜRKÜT', 'ucan-araba-simulasyonu', 'Simülasyonda geliştirmek',
    ...
    (15, 'ÇAĞRI', 'kablosuz-haberlesme', 'Bağlantıyı sürdürebilmek',
    ...
    (16, 'ALHAZEN', 'cevre-enerji-teknolojileri', 'Enerji ve malzemeye odaklanmak',
    ...
    (17, 'ASHİNA İNOVASYON', 'tarim-teknolojileri', 'Tarım için araştırmak',
    ...
    (18, 'Fikirden girişime', 'teknoloji-girisimciligi', 'Teknik üretimin ürün ve girişim boyutunu anlatmak.',
